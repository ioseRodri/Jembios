                  ...
                  <tbody>
                    {empList.map((e) => (
                      <tr key={e.id}>
                        ...
                        <td>
                          <span
                            className={`badge ${e.status === "ACTIVO" ? "badge-green" : "badge-gray"
                              }`}
                          >
                            {e.status}
                          </span>
                    ...
                    {taskList.slice(0, 10).map((t) => {
                      ...
                      return (
                        <tr key={t.id}>
                          ...
                          <td>
                            {displayName}
                            {!isSystem && <span className="muted"> ({t.assignee_id})</span>}
                          </td>
                          <td>{displayType}</td>
                          <td>
                            <span className={`badge ${isDone ? "badge-green" : "badge-yellow"}`}>
                              {computedUiStatus}
                            </span>
                          </td>
                          <td>
                            {!isDone ? (
                              <button className="btn-approve" onClick={() => completeTask(t.id)}>
                                Finalizado
                              </button>
                            ) : (
                      ...
                      <tbody>
                        {orders.map((o) => (
                          <tr key={o.id}>
                            ...
                            <td>
                              <button className="btn-link" onClick={() => openOrderDetail(o.id)}>
                                Ver detalle
                              </button>
                            </td>
                          </tr>
